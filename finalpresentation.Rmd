...
# Analysis: One Point In Soccer Is Worth X Points In Basketball
...
# How Long Do RSL Fans Cheer Compared to Jazz Fans pt. 2
...
I feel like this is the way to start it, but with the data we have, it doesn't seem too promising.

```{r}

# rslDatahome = rslData$Point.number %>% filter(grep1('home',location))
# rslData$hometime = rslData$Celebration.Time %>% filter(grep1('home',location))
# 
# plot(rslhomepoints, rslhometime)
# plot((jazzData$Point.number/ nbaScoresMean), (jazzData$Celebration.Time/nbaScoresMean))
# plot((jazzData$Celebration.Time/nbaScoresMean), (rslData$Celebration.Time/mlsScoresMean))
# plot((rslData$Point.number/mlsScoresMean), (jazzData$Point.number/ nbaScoresMean))
# 
# cor.test((rslData$Point.number/mlsScoresMean), (rslData$Celebration.Time/mlsScoresMean))
# cor.test((jazzData$Point.number/ nbaScoresMean), (jazzData$Celebration.Time/nbaScoresMean))
# cor.test((jazzData$Celebration.Time/nbaScoresMean), (rslData$Celebration.Time/mlsScoresMean))
# cor.test((rslData$Point.number/mlsScoresMean), (jazzData$Point.number/ nbaScoresMean))

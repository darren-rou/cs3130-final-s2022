...
hist(jazzCelebrationTimes,
     main="Histogram of Celebration Time (Jazz)",
     xlab="Total Time Fans Cheered After a Score",breaks=6)
...
```
From this t-test we have observed with 95% confidence the population mean will be within (`r jazzCelebrationTtest$conf.int[1]`, `r jazzCelebrationTtest$conf.int[2]`) seconds.



We also kept track of the same details in our RSL data collection as shown above. 

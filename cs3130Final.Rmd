...
hist(jazzCelebrationTimes,
     ...
     xlab="Total Time Fans Cheered After a Score")
jazzCelebrationRange <- c(1:12)
...
hist(jazzCelebrationTimes,breaks=0:14,freq=FALSE,add=TRUE, col = rgb(0,0,0,alpha=0.1))

...
One RSL point is worth how many Utah Jazz points? To answer this question, we start  consider the total points scored by the Jazz each game in the 2019--2020 and 2020--2021 seasons. We put this data into a `.csv` file, and using the `head()` function, we can create a table to see what it looks like:

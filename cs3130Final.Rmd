...
Next, we will see if the cheering times between fans of RSL and the Utah Jazz are significantly differen.t First, we will take the data we collected and compute the mean values for each. Similar to what we did in the previous section for the scoring data.

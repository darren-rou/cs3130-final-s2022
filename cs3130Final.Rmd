...
Here we have completed these computation and arrived at a ratio of `r lowRatio` for the lower bound and `r highRatio` for the higher bound. This means that one point scored by RSL is at least equivalent to `r lowRatio` Jazz points and at most equivalent to `r highRatio` Jazz points. These values will help give insight into why RSL fans cheer longer than Jazz fans.

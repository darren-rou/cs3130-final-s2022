...
There are too many columns comfortably display, but we are interested in the `home_score` and `away_score` columns.
...
mlsScoreRange <- c(-.5,0,.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5)
